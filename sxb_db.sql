...
CREATE TABLE IF NOT EXISTS `t_account` (
 ...
 `state`              tinyint(1)    NOT  NULL DEFAULT  0   COMMENT '登录状态,0为未登录,1为已登录',            
 ...
 `current_appid` int(11) NOT NULL DEFAULT 0 COMMENT '当前appid', 
  PRIMARY KEY (`uid`)
);
...
alter table `t_av_room` add column `finish_time` int(11) not null default 0 comment '结束时间' after `create_time`;
